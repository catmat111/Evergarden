...
{
    /// <inheritdoc />
    public partial class refactorBd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagemPath = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilizadorRemetenteFk = table.Column<int>(type: "INTEGER", nullable: false),
                    UtilizadorDestinatarioFk = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.UtilizadorDestinatarioFk,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cartas_Utilizadores_UtilizadorRemetenteFk",
                        column: x => x.UtilizadorRemetenteFk,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataEnvio = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataCriacao = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UtilizadoresFk = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartasId = table.Column<int>(type: "INTEGER", nullable: false),
                    CategoriasId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartasCategorias", x => new { x.CartasId, x.CategoriasId });
                    table.ForeignKey(
                        name: "FK_CartasCategorias_Cartas_CartasId",
                        column: x => x.CartasId,
                        principalTable: "Cartas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartasCategorias_Categorias_CategoriasId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cartas_UtilizadorDestinatarioFk",
                table: "Cartas",
                column: "UtilizadorDestinatarioFk");

            migrationBuilder.CreateIndex(
                name: "IX_Cartas_UtilizadorRemetenteFk",
                table: "Cartas",
                column: "UtilizadorRemetenteFk");

            migrationBuilder.CreateIndex(
                name: "IX_CartasCategorias_CategoriasId",
                table: "CartasCategorias",
                column: "CategoriasId");
