...
namespace ProjetoDW.Data.Migrations
{
    ...
    [Migration("20250531105048_RegularExpressionsUtilizadores")]
    partial class RegularExpressionsUtilizadores
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetoDW.Models.Categorias", b =>
                {
                    ...
                    b.Property<string>("UtilizadorCriadorId")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("UtilizadorCriadorId");
            ...
            modelBuilder.Entity("ProjetoDW.Models.Categorias", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UtilizadorCriador")
                        .WithMany()
                        .HasForeignKey("UtilizadorCriadorId");
